...
public class TowerAttackState extends AbstractGameSystem{
    ...
    protected void initialize() {
        ...
        this.towers = ed.getEntities(Range.class, Position.class, AttackMethodType.class,ProjectileType.class, AttackRate.class, TowerRotationSpeed.class);
    }
    ...
    public void update(SimTime tpf) {
        ...
        // itterate towers and apply collision detection
        towers.applyChanges();
        ...
        for (Entity e : towers) {
            ...
            boolean activate = simplePhysics.getWorld().detect(new AABB(location, range), CollisionFilters.FILTER_CATEGORY_TOWER_SENSOR, true, true, result);
