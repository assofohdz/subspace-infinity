...
public class CollisionFilters {
    ...
    private static final long COLLISION_CATEGORY_SENSOR_TOWER = 512;
    ...
    public static final CategoryFilter FILTER_CATEGORY_SENSOR_TOWER = new CategoryFilter(COLLISION_CATEGORY_SENSOR_TOWER,
            COLLISION_CATEGORY_DYNAMICS_MOBS);
