...
| 06 | **Arena objectives + roles** | 0015 | 03, 04, 05 | 🔨 in progress — [Inc A](issues/06-arena-objectives-roles.md) (objective static-goal nav + `hold-position`, tracer) landed; Inc B (bias) + Inc C (roles) pending |
