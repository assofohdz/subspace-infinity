...
public interface AccountSession {
    ...
    /**
     * Returns information about the server. Currently this is just a description.
     ...
     * notifyLoginStatus() to the client's AccountSessionListener. Note: this could
     * have been done synchronously but synchronous calls should generally be
     * avoided when they can. a) it prevents odd logic deadlocks if one isn't
